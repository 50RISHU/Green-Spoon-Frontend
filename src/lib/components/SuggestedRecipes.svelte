<script>
  export let onSubmit = (data) => {
    ...
    alert(`🔍 Searching ${queryType} recipes with:\nIngredients: ${data.ingredients}\nTime: ${data.time} mins`);
  };
...
<section class="container my-5 flex-grow-1">
  ...
  <p class="text-muted text-center mb-5">
    Enter your available ingredients and desired cooking time. Let Green Spoon suggest something tasty!
  </p>

  <div class="row justify-content-center">
    <div class="col-md-8">
      <form class="bg-white shadow rounded p-4" on:submit|preventDefault={handleSubmit}>
        <div class="mb-3">
        ...
        <button class="btn btn-success w-100" type="submit">🔍 Find Recipes</button>
      </form>
    </div>
  </div>
</section>
